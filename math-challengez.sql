...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 17, 2024 at 01:26 PM
...
INSERT INTO `administrator` (`id`, `username`, `firstname`, `lastname`, `email`, `usertype`, `email_verified_at`, `password`, `address`, `city`, `country`, `postal`, `about`, `remember_token`, `created_at`, `updated_at`) VALUES
...
--
-- AUTO_INCREMENT for table `school_representative`
--
ALTER TABLE `school_representative`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
COMMIT;
