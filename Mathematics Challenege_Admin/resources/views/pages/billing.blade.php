...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Upload Questions'])
...
<body>
    <div class="container mt-5">
        <div class="card">
            ...
            <h2 class="text-center bg-primary text-white">Upload Answer</h2>
            </div>
            <div class="card-body">
                @if (session('success'))
                ...
                <form action="{{ route('fileupload.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label text-white" for="file">Choose file...</label>
                        </div>
                    </div>
